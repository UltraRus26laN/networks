...
def post_request(text):
    ...
    print("dict_messages: ", dict_messages)
    try:
...
if __name__ == '__main__':
    ...
    parse.add_argument("--port", '-p', type=int, help='Set server port', default=8082)
    parse.add_argument("--directory", "-d", type=str, help='Set directory',
                       default='/Users/kirillverenic/projects/vuz/aposzi/laba1/public')
